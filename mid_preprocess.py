...
MIDI_DATASET_PATH = "bass"
SAVE_DIR = "dataset_bass"
SINGLE_FILE_DATASET = "file_dataset_bass"
MAPPING_PATH = "mapping_bass.json"
SEQUENCE_LENGTH = 64
...
def preprocess(dataset_path):
    ...
    for i, song in enumerate(songs):
        ...
        # split songs to treble and bass clef
        treble, bass = split_treble_bass(song)
...
if __name__ == "__main__":
    #main()
    song = m21.converter.parse('piano/pianoscore_0.mid')
    treble, bass = split_treble_bass(song)
    treble.show('text')

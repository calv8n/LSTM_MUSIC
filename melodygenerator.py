...
from mid_preprocess import SEQUENCE_LENGTH, MAPPING_PATH
...
class MelodyGenerator:
    ...
    def _sample_with_temperature(self, probabilites, temperature):
        ...
        # param temperature (float): Float in interval [0, inf]. Numbers closer to 0 make the model more deterministic.
        # A number closer to 1 and over makes the generation more unpredictable.
...
if __name__ == "__main__":
    mg = MelodyGenerator()
    seed = "38 _ _ _ _ 40 _ 42 _ _ 40 _ _ _ 38 _ _ _ 40 _ _ 42"
    seed2 = "32 _ _ _ 30 _ _ 31"
    melody = mg.generate_melody(seed, 500, SEQUENCE_LENGTH, 0.6)
    print(melody)
    pre = seed2.split()
    mg.save_melody(pre, file_name="pre.mid")
    mg.save_melody(melody, file_name="mel_bass.mid")
